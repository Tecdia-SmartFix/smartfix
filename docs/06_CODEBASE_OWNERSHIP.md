...
| `components/MessageContent.jsx` | Vijay | Eshita | LLM message renderer (markdown + sources) + message design. |
...
| `context/ThemeContext.jsx` | Eshita | — | Global design tokens & brand colors |
...
| `index.css` | Eshita | Vijay | Global styles |
